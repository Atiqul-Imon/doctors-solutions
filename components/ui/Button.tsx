...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading = false, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-primary-500 text-white hover:bg-primary-600 focus:ring-primary-500 shadow-md hover:shadow-lg active:scale-95',
      ...
      success: 'bg-medical-green text-white hover:bg-green-600 focus:ring-medical-green shadow-md hover:shadow-lg active:scale-95',
    };
